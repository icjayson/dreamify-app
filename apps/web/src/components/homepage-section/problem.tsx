      ...
      <div className="max-w-full relative z-10 container mx-auto px-2">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
          ...
          >
            ...
            <h3 className="mt-4 text-lg md:text-xl font-medium text-white">Bounded. Visual. Conversational.</h3>
            <p className="mt-0 text-white/60">Chat over a supported file, then review and edit the generated dashboard.</p>
            <div
              className="mt-20 mx-4 rounded-xl overflow-hidden hover:scale-[1.01] transition-transform duration-200"
            >
              <video
