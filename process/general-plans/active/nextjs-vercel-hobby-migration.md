...
| 1 | npm monorepo, locked runtimes, canonical contracts, CI, 817-case ledger | Implemented and locally verified; private `main` and source tags pushed, CI closure in progress |
...
| 6 | GitHub/Vercel linkage, owner-managed Neon/Clerk setup, deploy and smoke | GitHub and both Vercel projects are linked; deployment remains blocked on Neon legal acceptance and a new Clerk application |
