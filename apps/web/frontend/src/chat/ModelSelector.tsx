              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-semibold text-foreground dark:text-white">Standard</span>
            ...
            <div className="mt-2 border-t border-border dark:border-white/5 bg-black/[0.02] dark:bg-white/[0.02] p-4">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                  <CreditIcon className={`w-3.5 h-3.5 ${creditState === 'empty' || creditState === 'critical' ? 'text-red-500 dark:text-red-400' : creditState === 'warning' ? 'text-amber-500 dark:text-amber-400' : 'text-foreground dark:text-white'}`} glow={false} />
