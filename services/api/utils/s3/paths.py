...
def build_asset_key(
    user_id: str, project_id: str, asset_id: str, file_id: str, extension: str
) -> str:
    """
    ...
    """
    return (
        f"users/{user_id}/projects/{project_id}/assets/{asset_id}/{file_id}.{extension}"
    )
...
def build_dashboard_version_key(
    user_id: str,
    project_id: str,
    dashboard_id: str,
    version: int,
    ...
    """
    Immutable dashboard version snapshot path.
    Structure: users/{user_id}/projects/{project_id}/dashboards/{dashboard_id}/versions/{version}.json
    """
    return (
        f"users/{user_id}/projects/{project_id}/dashboards/"
        f"{dashboard_id}/versions/{version}.json"
    )
