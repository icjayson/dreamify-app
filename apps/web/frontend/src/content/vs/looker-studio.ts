...
export const lookerStudio: ComparisonContent = {
  ...
  tldr: [
    { dimension: "Cost", competitor: "Free", dreamify: "Sandbox free · Pro $15/mo" },
  ...
  pricing: { competitor: "Free (paid third-party connectors for non-Google data)", dreamify: "Sandbox free · Pro $15/mo · Team $18/seat" },
  migrationNotes:
