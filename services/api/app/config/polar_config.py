...
class PolarConfig:
    ...
    def __init__(self):
        ...
        self.access_token = getattr(polar_settings, 'access_token', None) if polar_settings else None
        self.organization_id = getattr(polar_settings, 'organization_id', None) if polar_settings else None
        self.webhook_secret = getattr(polar_settings, 'webhook_secret', None) if polar_settings else None
        self.is_sandbox = getattr(polar_settings, 'is_sandbox', True) if polar_settings else True
