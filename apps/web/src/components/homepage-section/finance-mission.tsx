...
export function FinanceMissionSection({ ctaText = "Open File Preview", ctaLink = "/login" }: { ctaText?: string; ctaLink?: string }) {
  ...
  return (
    <section className="relative min-h-screen w-full flex items-center justify-center">
      <div ref={rootRef} className="max-w-6xl mx-auto px-6 text-center">
        ...
        >
          Explore cash-flow, variance, and unit-economics questions from files you upload. This Hobby demo is an analytical preview, not an accountant, financial adviser, or live accounting integration.
        </p>
