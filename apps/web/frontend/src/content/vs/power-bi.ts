...
export const powerBi: ComparisonContent = {
  ...
  tldr: [
    ...
    { dimension: "Pricing", competitor: "$10–$20/user/month + capacity costs", dreamify: "Sandbox free · Pro $15/mo · Team $18/seat" },
  ],
  scenario: {
  ...
  dreamifyWins: [
    ...
    },
    {
      ...
      body: "$15/mo Pro or $18/seat Team — no capacity SKU, no per-user-per-feature surprises.",
    },
  ],
  pricing: {
