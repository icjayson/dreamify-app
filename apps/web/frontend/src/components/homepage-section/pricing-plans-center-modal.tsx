    ...
    <section className={cn("py-6 w-full", className)}>
      <div ref={rootRef} className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch">
          {/* Sandbox Plan */}
          <div
            className={`rounded-xl border border-border dark:border-white/10 bg-foreground/5 dark:bg-white/5 p-5 h-full flex flex-col transition-all duration-700 ease-out delay-[100ms] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <h3 className="text-base font-semibold text-foreground dark:text-white">Sandbox</h3>
            <div className="mt-2 flex items-baseline gap-1">
              <span className="text-3xl font-bold text-foreground dark:text-white">$0</span>
              <span className="text-muted-foreground dark:text-white/60 text-xs">/ month</span>
            </div>
            <p className="mt-2 text-muted-foreground dark:text-white/50 text-xs">Our baseline features, always available for individuals starting out.</p>
            <ul className="my-4 space-y-2 text-xs text-muted-foreground dark:text-white/70 flex-1">
            ...
            <button
              disabled
              className="mt-auto w-full border border-border dark:border-white/10 bg-foreground/5 dark:bg-white/5 text-muted-foreground dark:text-white/40 rounded-lg py-2 text-xs font-medium"
            >
              Base Plan
            </button>
          </div>
          ...
          <div
            className={`rounded-xl border-2 p-5 h-full flex flex-col relative transition-all duration-700 ease-out delay-[200ms] ${isVisible
              ? isSignedIn
                ? "border-primary bg-primary/20 shadow-[0_0_40px_-12px_rgba(139,92,246,0.3)] dark:shadow-[0_0_40px_-12px_rgba(139,92,246,0.5)] scale-[1.02]"
                : "border-primary/40 bg-primary/10 shadow-[0_0_30px_-15px_rgba(139,92,246,0.2)] dark:shadow-[0_0_30px_-15px_rgba(139,92,246,0.3)]"
          ...
          >
            ...
            <h3 className="text-base font-semibold text-foreground dark:text-white">Pro</h3>
            <div className="mt-2">
              <span className="text-3xl font-bold text-foreground dark:text-white tracking-tighter">TBD</span>
            </div>
            <p className="mt-3 text-primary font-bold text-sm leading-tight uppercase tracking-wide">
              Free Access During Preview
            </p>
            <ul className="my-4 space-y-2 text-xs text-foreground/80 dark:text-white/80 flex-1">
              <li className="flex items-center gap-2 font-medium text-foreground dark:text-white">{checkIcon} 1,000 monthly credits</li>
          ...
          {/* Enterprise Plan */}
          <div
            className={`rounded-xl border border-border dark:border-white/10 bg-foreground/5 dark:bg-white/5 p-5 h-full flex flex-col transition-all duration-700 ease-out delay-[300ms] ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
          >
            <h3 className="text-base font-semibold text-foreground dark:text-white">Enterprise</h3>
            <div className="mt-2 flex items-baseline gap-1">
              <span className="text-3xl font-bold text-foreground dark:text-white">Custom</span>
            </div>
            <p className="mt-2 text-muted-foreground dark:text-white/50 text-xs">Tailored solutions for large teams and high-volume data needs.</p>
            <ul className="my-4 space-y-2 text-xs text-muted-foreground dark:text-white/70 flex-1">
