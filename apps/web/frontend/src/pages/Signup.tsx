        ...
        <div className="glass-panel border border-border rounded-3xl overflow-hidden grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="hidden md:flex flex-col justify-center gap-6 p-10 bg-gradient-to-br from-primary/70 via-primary/30 to-white/60 backdrop-blur-2xl dark:from-primary/10 dark:via-background dark:to-accent/10">
            ...
            <ul className="space-y-3 text-foreground/80 dark:text-white/80">
              <li className="flex items-center gap-3"><CheckCircle2 className="w-5 h-5 text-foreground/60 dark:text-white/90" /> No credit card required</li>
              <li className="flex items-center gap-3"><CheckCircle2 className="w-5 h-5 text-foreground/60 dark:text-white/90" /> Get started in minutes</li>
              <li className="flex items-center gap-3"><CheckCircle2 className="w-5 h-5 text-foreground/60 dark:text-white/90" /> Cancel anytime</li>
            </ul>
          </div>
