...
const BlankState: React.FC<BlankStateProps> = ({
  ...
  const selectConnector = (name: string) => {
    try {
      ...
      // A missing chat root is non-fatal; the connector menu still closes.
    }
    setMenuOpen(false);
  };
  ...
  return (
    <div className={`h-full flex items-center justify-center ${className}`}>
      ...
      >
        ...
        <h2 id="blankstate-title" className="text-lg font-semibold mb-2">Get Started with Dreamify</h2>
