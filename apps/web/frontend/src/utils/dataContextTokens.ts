...
const CONNECTOR_ALIASES: Array<{
  ...
  { name: "Shopify", shortName: "Shopify", aliases: ["shopify", "shopify_commerce", "integration_shopify"] },
  { name: "Klaviyo", shortName: "Klaviyo", aliases: ["klaviyo", "lifecycle_marketing", "integration_klaviyo"] },
  { name: "QuickBooks", shortName: "QuickBooks", aliases: ["quickbooks", "quick books", "qbo", "integration_quickbooks"] },
  ...
  { name: "TikTok Shop Seller", shortName: "TikTok Shop", aliases: ["tiktok_shop_seller", "tiktok shop seller", "tiktok shop", "integration_tiktok_shop_seller"] },
