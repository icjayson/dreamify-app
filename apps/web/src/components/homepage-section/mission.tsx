  ...
  return (
    <section className={cn("relative min-h-screen w-full flex items-center justify-center", className)}>
      <div ref={rootRef} className="max-w-6xl mx-auto px-6 text-center">
        ...
        >
          From a supported data file to an editable, explainable dashboard.
        </h2>
        ...
        >
          Dreamify reimagines data storytelling. Upload a bounded data file, generate an editable dashboard, and refine the result through version history.
        </p>
