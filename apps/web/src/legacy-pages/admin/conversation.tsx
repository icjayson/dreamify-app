import { useParams, useSearchParams, useNavigate } from '@/lib/navigation';
          ...
          <div className="mb-6">
            ...
            {conversation && (
              <p className="text-sm text-muted-foreground mt-1">
                ID: <span className="font-mono">{stringValue(conversation.conversation_id)}</span>
              </p>
            )}
          </div>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2 text-sm">
                      <div>
                        ...
                        <span className="ml-2 font-mono text-xs">{stringValue(conversation.user_id)}</span>
                      </div>
                      <div>
                        <span className="font-medium">Project ID:</span>
                        <span className="ml-2 font-mono text-xs">{stringValue(conversation.project_id)}</span>
                      </div>
                      <div>
                        <span className="font-medium">Conversation ID:</span>
                        <span className="ml-2 font-mono text-xs">{stringValue(conversation.conversation_id)}</span>
                      </div>
                      {(() => {
                      ...
                      <div>
                        ...
                        <span className="ml-2">
                          {formatToDisplay(stringValue(conversation.created_at) ?? '', { format: 'full' })}
                        </span>
                      </div>
                      <div>
                        <span className="font-medium">Updated:</span>
                        <span className="ml-2">
                          {formatToDisplay(stringValue(conversation.updated_at) ?? '', { format: 'full' })}
                        </span>
                      </div>
                    </CardContent>
                  </Card>
