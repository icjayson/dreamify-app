...
export class ChartConfigHelpers {
  ...
  static getDefaultConfig(type: ChartType): Record<string, any> {
    const configs: Partial<Record<ChartType, Record<string, any>>> = {
      [ChartType.LINE]: {
        animation: true,
        showGrid: true,
        showLegend: true,
  ...
  static getColorScheme(type: ChartType): string[] {
    const schemes: Partial<Record<ChartType, string[]>> = {
      [ChartType.LINE]: [
        'hsl(var(--primary))',
        'hsl(var(--secondary))',
        'hsl(var(--accent))',
  ...
  static getAnimationConfig(type: ChartType): {
    ...
    const animations: Partial<Record<ChartType, { enabled: boolean; duration: number; easing: string; delay?: number }>> = {
      [ChartType.LINE]: {
        enabled: true,
        duration: 1000,
        easing: 'ease-out',
  ...
  static getLayoutConfig(type: ChartType): Record<string, any> {
    const layouts: Partial<Record<ChartType, Record<string, any>>> = {
      [ChartType.LINE]: {
