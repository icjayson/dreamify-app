...
const QUESTIONS: Question[] = [
  ...
  { id: "share_link_rating", type: "rating", title: "How useful do you find the dashboard share link feature?", required: true },
  {
  ...
  },
  {
    ...
    type: "textarea",
    title: "What improvements do you want for share links, or which export type would you like added most?",
    required: true,
    placeholder: "For example: PNG, PDF, scheduled exports, permissions...",
  },
];
