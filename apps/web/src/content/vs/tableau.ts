...
export const tableau: ComparisonContent = {
  ...
  tldr: [
    ...
    { dimension: "License cost", competitor: "$15–$75/user/mo (Creator: $75)", dreamify: "Free non-commercial preview · billing disabled" },
  ...
  dreamifyWins: [
    {
      ...
      body: "Free invitation-only preview for evaluation; it is not a commercial Tableau replacement SLA.",
    },
    {
