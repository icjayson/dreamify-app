...
import { featureCapability, useCapabilities } from "@/hooks/useCapabilities";
...
export default function ConnectorEntityDetailView(props: Props) {
  ...
  return (
    <>
      ...
      {scheduleDefaults && scheduling.enabled && (
        <CreateScheduleModal
          open={scheduleOpen}
