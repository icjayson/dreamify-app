...
export const airbook: ComparisonContent = {
  ...
  tldr: [
    ...
    { dimension: "Pricing", competitor: "Mid-market analyst tooling", dreamify: "Sandbox free · Pro $15/mo · Team $18/seat" },
  ],
  scenario: {
  ...
  pricing: { competitor: "Mid-market analyst tooling pricing", dreamify: "Sandbox free · Pro $15/mo · Team $18/seat" },
};
