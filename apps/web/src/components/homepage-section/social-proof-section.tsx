...
export const SocialProofSection = () => {
  ...
  const testimonials = [
    {
      quote: "Dreamify transformed our quarterly reviews. What used to take our team 3 days now takes 15 minutes, and looks infinitely better.",
      author: "Sarah Chen",
    ...
    {
      quote: "Our investors are impressed by the professional quality of our data presentations. Dreamify gives us that competitive edge.",
      author: "Emily Watson",
      role: "CEO",
        ...
        <div className={`text-center mb-8 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
          ...
          <h2 className="text-3xl md:text-5xl font-bold mb-4 flex items-center justify-center gap-4 flex-wrap">
            ...
            <div className="gradient-panel rounded-xl px-6 py-3">
              <span className="text-white font-bold text-3xl md:text-5xl">innovative teams</span>
            </div>
          </h2>
          ...
          <div className="inline-flex items-center glass-panel rounded-full hover:shadow-[0_0_10px_hsl(var(--primary)_/_0.6),_5px_5px_20px_0_hsl(var(--primary)_/_0.4),_0_0_0_1px_hsl(var(--primary)_/_0.2)] px-8 py-2">
            <div className="flex items-center space-x-6">
              <div className="flex items-center">
                ...
                <span className="text-xs text-muted-foreground">Invite-only preview</span>
              </div>
              <div className="w-px h-4 bg-border"></div>
              <div className="flex items-center">
                <div className="w-2 h-2 rounded-full bg-blue-500 mr-2 animate-pulse"></div>
                <span className="text-xs text-muted-foreground">Billing disabled</span>
              </div>
              <div className="w-px h-4 bg-border"></div>
              <div className="flex items-center">
                <div className="w-2 h-2 rounded-full bg-accent mr-2 animate-pulse"></div>
                <span className="text-xs text-muted-foreground">Capability gated</span>
              </div>
            </div>
          </div>
        </div>
