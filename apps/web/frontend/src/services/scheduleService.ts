...
export type ProviderKey = 'ga4' | 'meta_ads' | 'tiktok' | 'appsflyer' | 'stripe' | 'hubspot' | 'salesforce' | 'pipedrive' | 'supabase' | 'shopify' | 'klaviyo' | 'quickbooks' | 'zendesk' | 'mixpanel' | 'posthog' | 'amazon_seller' | 'tiktok_shop_seller' | 'shopee_seller' | 'lazada_seller' | 'warehouse';
