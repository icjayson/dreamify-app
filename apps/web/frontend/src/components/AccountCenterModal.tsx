                    ...
                    <div className="space-y-1">
                      {sidebarItems.map(item => (
                        <button
                          ...
                          className={`w-full flex items-center justify-between gap-2 px-3 py-3 rounded-md text-sm hover:bg-black ${mobileActiveTab === item.key ? 'bg-black text-white' : 'text-white/80'}`}
                        >
                          <span className="flex items-center gap-2"><span className="text-white/80">{item.icon}</span><span>{item.label}</span></span>
                          <svg className="w-4 h-4 text-white/60" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
                        </button>
                      ))}
                    </div>
                ...
                <div className="relative z-10 w-full h-[calc(80vh-20px)] bg-muted overflow-hidden flex flex-col">
                  ...
                  <div className="flex items-center justify-between px-3 py-2 border-b border-border">
                    <button
                      ...
                      className="flex items-center gap-2 text-sm text-white/80 hover:text-white hover:bg-white/10 rounded-md px-2 py-1"
                    >
