...
export const juliusAi: ComparisonContent = {
  ...
  tldr: [
    ...
    { dimension: "Pricing", competitor: "$20/mo+", dreamify: "Sandbox free · Pro $15/mo · Team $18/seat" },
  ],
  scenario: {
  ...
  dreamifyWins: [
    ...
    },
    {
      ...
      body: "Pro at $15/mo includes 1,000 credits, unlimited connectors, and workspace agents.",
    },
  ],
  pricing: { competitor: "From $20/mo per user", dreamify: "Sandbox free · Pro $15/mo · Team $18/seat" },
  migrationNotes:
