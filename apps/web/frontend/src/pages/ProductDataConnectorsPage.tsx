...
const DATA_CONNECTORS_FAQ: { question: string; answer: string }[] = [
  {
    ...
    answer:
      "A data connector is a live, authenticated link between Dreamify and one of your business systems — your ad accounts, analytics, payment processor, ecommerce store, support desk, product analytics workspace, spreadsheets, or warehouse. Once connected, Dreamify reads the source on a schedule, joins the data with everything else you've connected, and uses it to generate AI dashboards on demand. No SQL, no data modeling, no manual exports.\n\nDreamify ships native and queued connector surfaces for the platforms marketers, founders, and operators actually use: Meta Ads, Google Ads, GA4, TikTok Ads, AppsFlyer, Firebase, Google Search Console, Mixpanel, PostHog, Stripe, QuickBooks, Zendesk, Shopify, Klaviyo, Amazon Seller, TikTok Shop Seller, Shopee Seller, Lazada Seller, HubSpot, Salesforce, Pipedrive, Google Sheets, PostgreSQL, BigQuery, Snowflake, Databricks, and Supabase. Each connector is read-only by default and uses OAuth or scoped credentials for security.",
  },
  {
    question: "Which data sources does Dreamify connect to?",
    answer:
      "Native connector surfaces include Meta Ads, Google Ads, GA4, TikTok Ads, AppsFlyer, Firebase, Google Search Console, Mixpanel, PostHog, Stripe, QuickBooks, Zendesk, Shopify, Klaviyo, Amazon Seller, TikTok Shop Seller, Shopee Seller, Lazada Seller, HubSpot, Salesforce, Pipedrive, Google Sheets, PostgreSQL, BigQuery, Snowflake, Databricks, and Supabase. Unavailable cards remain gated until their live sync and schedule smoke tests pass.",
  },
  {
