...
export const FeaturesSection = () => {
  ...
  const steps: Step[] = useMemo(
    () => [
      {
        id: "conversational",
        title: "File-to-Dashboard Workflow",
        description: "Upload a supported file, describe the dashboard you need, and review the generated result.",
        icon: MessageCircle,
        videoSrc: MARKETING_MEDIA.dashboard,
        bullets: [
          "Upload your data",
          "Describe your desired dashboard output",
          "Dreamify generates an editable dashboard within the bounded preview workflow",
        ],
      },
      {
        id: "insight",
        title: "Layout Editing and Insight Review",
        description: "Edit the layout and inspect the evidence behind each generated insight.",
        icon: Brain,
        videoSrc: MARKETING_MEDIA.editAndInsight,
        bullets: [
          "Manually edit layout or chat with Dreamify",
          "Review structured insights for each metric",
        ],
      },
      {
        id: "visualization",
        title: "Versioned Dashboard Editing",
        description: "Refine a dashboard, preserve versions, and return to an earlier result safely.",
        icon: Sparkles,
        videoSrc: MARKETING_MEDIA.export,
        bullets: [
          "Edit layouts and dashboard content",
          "Review and restore previous versions",
          "Export results; public preview links stay disabled",
        ],
      },
    ],
    []
