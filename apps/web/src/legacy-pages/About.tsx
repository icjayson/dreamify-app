...
const AboutPage = () => {
  ...
  return (
    <>
      <Seo
        title="About Dreamify — Invitation-only Analytics Preview"
        description="Dreamify is a personal, non-commercial Hobby demo for turning bounded data files into explainable insights and editable dashboards."
        canonical="https://dreamify-web.vercel.app/about"
        jsonLd={{
          "@context": "https://schema.org",
          "@type": "AboutPage",
          "@id": "https://dreamify-web.vercel.app/about#webpage",
          url: "https://dreamify-web.vercel.app/about",
          name: "About Dreamify",
