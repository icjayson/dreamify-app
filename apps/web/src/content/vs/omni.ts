...
export const omni: ComparisonContent = {
  ...
  tldr: [
    ...
    { dimension: "Pricing", competitor: "Enterprise / mid-market", dreamify: "Free non-commercial preview · billing disabled" },
  ],
  scenario: {
  ...
  dreamifyWins: [
    ...
    },
    {
      ...
      body: "Free invitation-only preview with technical usage limits; no commercial plan is offered on Hobby.",
    },
  ],
  pricing: { competitor: "Enterprise / mid-market pricing", dreamify: "Free non-commercial preview · billing disabled" },
};
